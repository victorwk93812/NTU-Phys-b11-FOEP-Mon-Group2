...
datasource = ["../data/A5-1.csv", "../data/A5-2.csv"]
...
axs[0][0].legend()
# plt.savefig("../pics/MgO200-XRD.png")
# plt.show()
...
axs[0][1].legend()
# plt.savefig("../pics/Si400-XRD.png")
# plt.show()
...
axs[1][0].legend()
# plt.savefig("../pics/LaAlO3100-XRD.png")
# plt.show()
...
axs[1][1].legend()
# plt.savefig("../pics/LaAlO3200-XRD.png")
# plt.show()
...
axs[2][0].legend()
# plt.savefig("../pics/LaAlO3300-XRD.png")
# plt.show()
...
axs[3][0].legend()
# plt.savefig("../pics/Si440-XRD.png")
# plt.show()
...
axs[3][1].legend()
# plt.savefig("../pics/Si404-XRD.png")
